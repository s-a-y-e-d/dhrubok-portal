...
export default async function OwnerAttendanceReport({ params, searchParams }: { params: Promise<{ locale: string; batchId: string }>; searchParams: Promise<{ from?: string; to?: string }> }) {
